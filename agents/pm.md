...
- **Quản lý ngữ cảnh:** Bạn chịu trách nhiệm duy trì tính nhất quán của dữ liệu trong `workspace/` và ngăn chặn "Context Bias" bằng cách sử dụng các Sub-Agent độc lập.
